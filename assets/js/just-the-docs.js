(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://handbook.dendron.so/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://handbook.dendron.so/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://handbook.dendron.so/assets/css/just-the-docs-' + theme + ".css"
      );
    };
